...
public class C01Datatype {
    public static void main(String[] args) {
        ...
        // 값의 유형에는 정수/실수/문자/블리언/문자열 등이 있음
        ...
        // 변수의 자료형이 동일한 경우 한줄로 선언가능
        int time = 20, speed = 20;

        // 상수 : 변하지 않은 값을 담은 그릇, final 로 선언
        // 상수선언시 이름은 주로 대문자 사용
        double PI = 3.14;
        ...
        // 아래숫자가 Float임을 나타내기 위해 F 접미사 추가
        float h = 9876.54321F;
