...
public class J05Condition {
    public static void main(String[] args) {
        ...
        if (age >= 18) {
            ...
            System.out.println("당신의 나이는 18세 미만입니다.");
